...
srun python /RG/compbio/michaelel/data/run_sbatch_files/mslearn_distrib_hypsrch_v2.py -w /RG/compbio/michaelel/data/run_sbatch_files -i $SLURM_ARRAY_TASK_ID -j /RG/compbio/michaelel/data/run_sbatch_files/mslearn_input_extended_v3_cleaned_valid.json